if (navigator.serviceWorker) {
  this.navigator.serviceWorker
    .register("../sw.js")
    .then((reg) => console.log("Registered Success", reg))
    .catch((err) => console.log("error In Load", err));
}
...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if (wScroll >= aboutOffset - 70) {
      ...
      $(`#btnUp`).fadeIn(500);
      let progressBars = Array.from(
        document.querySelectorAll(".about .progress-bar")
      );
